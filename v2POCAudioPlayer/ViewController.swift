...
//  v2POCAudioPlayer
//
//  Created by Kunal Parekh on 24/01/18.
...
class ViewController: UIViewController,AVAudioPlayerDelegate {
   ...
   //var audioVisualizer: ATAudioVisualizer!
    ...
    func initAudioVisualizer() {
       ...
       // self.initAudioVisualizer = initAudioVisualizer(barsNumber: 11, frame: frame, andColor: visualizerColor)
        //visualizerView.addSubview(initAudioVisualizer)
    }
    ...
    @objc func visualizerTimerChanged(_ timer:CADisplayLink)
    {
        ...
        let maxPower: Double =  Double(audioPlayer.peakPower(forChannel: 0))
        
        print("Peak Power \(maxPower)")
